...
export const MUSCULOSKELETAL: MusculoskeletalEntry[] = [
  ...
  },
  {
    ...
    distinguishFrom: [
      "Corpus spongiosum — single ventral erectile body surrounding urethra; less rigid engorgement",
      "Tunica albuginea — fibrous envelope of each corpus cavernosum, not the erectile sinusoids themselves",
