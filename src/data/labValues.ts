...
export const LAB_VALUES: LabValueEntry[] = [
  ...
  },
  {
    ...
    boardsPearls: [
      ...
      "↓ FRC → atelectasis risk, ↓ oxygen reserve, faster desaturation during apnea (obesity, anesthesia, infants)",
      "↑ FRC in COPD from air trapping (↑ RV) — hyperinflation flattens diaphragm",
    ...
    pairWith: [
      ...
      "↑ FRC + ↑ RV + ↓ FEV₁/FVC → COPD hyperinflation",
